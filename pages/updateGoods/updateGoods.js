...
Page({
  ...
  addPrice(){
    let newPriceList = this.data.PriceList;
    let name = ''
    let morethanthree = false
    if(this.data.PriceList.length==0){
      name = '商品单价：'
    }else if(this.data.PriceList.length==1){
      name = '批发单价：'
    }else if(this.data.PriceList.length==2){
      name = '二批单价：'
    }else{
      morethanthree = true
    }
    if(morethanthree==false){
      let param = {levelname:name,
        maxnum:'',
        minnum:'',
        name:'',
        price:''}
      newPriceList.push(param);
  ...
  deletePrice(){
    let thekey = Number(this.data.PriceList.length)-1;
    let newPriceList = this.data.PriceList;
    newPriceList.splice(thekey,1);
    this.setData({
      PriceList:newPriceList
    })
  },
  ...
  insertGoods(){
    ...
    app.globalData.db.collection('goods').add({
      data:{
        ...
        priceList:_this.data.PriceList,
  ...
  changeListPcice(e){
    ...
    let index = e.currentTarget.dataset.index
    let newPriceList = this.data.PriceList
    newPriceList[index].price = e.detail.value
    this.setData({
      PriceList:newPriceList
    })
  },
  changeListName(e){
    ...
    let index = e.currentTarget.dataset.index
    let newPriceList = this.data.PriceList
    newPriceList[index].name = e.detail.value
    this.setData({
      PriceList:newPriceList
    })
  },
  changeListMin(e){
    ...
    let index = e.currentTarget.dataset.index
    let newPriceList = this.data.PriceList
    newPriceList[index].minnum = e.detail.value
    this.setData({
      PriceList:newPriceList
    })
  },
  changeListMax(e){
    ...
    let index = e.currentTarget.dataset.index
    let newPriceList = this.data.PriceList
    newPriceList[index].maxnum = e.detail.value
    this.setData({
      PriceList:newPriceList
    })
  },
